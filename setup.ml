...
(* OASIS_START *)
(* DO NOT EDIT (digest: c0bbdd0a242af79eaa407e823e0752b5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["INAJIMA Daisuke"];
          homepage = None;
          synopsis = "Shogi Kifu Analyzer";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "anyalyzer.ml"})
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\187\131s\146q\239\160(\r\202\255!\127\1371\200";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
